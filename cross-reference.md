...
| Optional dependencies | package.json | `yarn.lock` comparison |
| --------------------- | :----------: | :--------------------: |
...
| devDependencies                            | package.json |                                                         `yarn.lock` comparison                                                          |
| ------------------------------------------ | :----------: | :-------------------------------------------------------------------------------------------------------------------------------------: |
...
| @jest/globals                              |    26.6.0    | 26.6.0 present as pinned version, gets bumped to 26.6.1 as part of a range update, gets bumped to 26.6.1 as dependency for jest-runtime |
